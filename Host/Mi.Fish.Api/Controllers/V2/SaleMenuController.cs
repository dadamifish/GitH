...
namespace Mi.Fish.Api.Controllers.V2
{
    /// <summary>
    /// 
    /// </summary>
    [ApiVersion("2.0")]
    public class SaleMenuV2Controller : FishControllerBase
    {
        ...
        public SaleMenuV2Controller(ISaleMenuAppService saleMenuAppService, IOrderNoAppService orderNoAppService)
        {
        ...
        /// </summary>
        /// <returns></returns>
        [HttpGet("OrderNo"), MapToApiVersion("3.0")]
